...
if __name__ == '__main__':
	...
	xbmc.executebuiltin('ActivateWindow(Videos,plugin://plugin.video.watchdogs/?action=%s&url=https://api.trakt.tv/%s/%s/related,return)' % (action, 'shows' if 'tvshows' in action else 'movies', imdb))