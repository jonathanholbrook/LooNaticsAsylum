...
class indexer:
    ...
    def getx(self, url, worker=False):
        try:
            ...
            url = regex.resolve(r)
            self.list = self.watchdogs_list('', result=url)
            self.addDirectory(self.list)
            return self.list
        except:
            pass
    ...
    def tvtuner(self, url):
        try:
            ...
            self.list = self.watchdogs_list('', result=result)
            if preset == 'tvtuner':
                self.addDirectory(self.list, queue=True)
            else:
                self.worker()
    ...
    def addSearch(self, url):
            ...
            self.list = [] ; threads = []
            for link in links:
                threads.append(workers.Thread(self.watchdogs_list, link))
    ...
    def watchdogs_list(self, url, result=None):
        try:
            if result is None:
    ...
    def root(self):
        try:
            regex.clear()
            url = base64.b64decode ('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3dhdGNoZG9nczM2L2RlZHNlYy9tYXN0ZXIvd2F0Y2hkb2dzL3dkbTN1L3dkbTN1LnhtbA==')
            self.list = self.watchdogs_list(url)
    ...
    def root_music(self):
        try:
            regex.clear()
            url = base64.b64decode ('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3dhdGNoZG9nczM2L2RlZHNlYy9tYXN0ZXIvd2F0Y2hkb2dzL211c2ljL211c2ljLnhtbA==')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_oneclick(self):
        try:
            regex.clear()
            url = base64.b64decode ('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3dhdGNoZG9nczM2L2RlZHNlYy9tYXN0ZXIvd2F0Y2hkb2dzL29uZWNsaWNrL29uZWNsaWNrLnhtbA==')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_swift(self):
        try:
            regex.clear()
            url = base64.b64decode ('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3dhdGNoZG9nczM2L2RlZHNlYy9tYXN0ZXIvd2F0Y2hkb2dzL3N3aWZ0L3N3aWZ0LnhtbA==')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_tvtap(self):
        try:
            regex.clear()
            url = base64.b64decode ('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3dhdGNoZG9nczM2L2RlZHNlYy9tYXN0ZXIvd2F0Y2hkb2dzL3R2dGFwL3R2dGFwLnhtbA==')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_porn(self):
        try:
            regex.clear()
            url = base64.b64decode ('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3dhdGNoZG9nczM2L2RlZHNlYy9tYXN0ZXIvd2F0Y2hkb2dzL3Bvcm4vcG9ybi54bWw=')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
...
class player(xbmc.Player):
    ...
    def play(self, url, content=None):
        try:
            ...
            control.execute('Dialog.Close(busydialog)')
            if url is None:
                return control.infoDialog(control.lang(32401).encode('utf-8'))
            if url is False:
                return
            meta = {}
