...
contextSettings = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.settings')
traktManager = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.traktManager')
clearProviders = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.clearProviders')
clearBookmark = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.clearBookmark')
rescrape = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.rescrape')
playFromHere = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.playFromHere')
playAction = xbmcaddon.Addon('plugin.video.watchdogs').getSetting('hosts.mode')
autoPlay = 'true' if playAction == '2' else ''
cm_autoPlay = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.autoPlay')
sourceSelect = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.sourceSelect')
findSimilar = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.findSimilar')
browseSeries = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.browseSeries')
browseEpisodes = xbmcaddon.Addon('context.watchdogs').getSetting('context.watchdogs.browseEpisodes')

homeWindow.setProperty('context.watchdogs.settings', contextSettings)
homeWindow.setProperty('context.watchdogs.traktManager', traktManager)
homeWindow.setProperty('context.watchdogs.clearProviders', clearProviders)
homeWindow.setProperty('context.watchdogs.clearBookmark', clearBookmark)
homeWindow.setProperty('context.watchdogs.rescrape', rescrape)
homeWindow.setProperty('context.watchdogs.playFromHere', playFromHere)
homeWindow.setProperty('plugin.video.watchdogs.autoPlay', autoPlay)
homeWindow.setProperty('context.watchdogs.autoPlay', cm_autoPlay)
homeWindow.setProperty('context.watchdogs.sourceSelect', sourceSelect)
homeWindow.setProperty('context.watchdogs.findSimilar', findSimilar)
homeWindow.setProperty('context.watchdogs.browseSeries', browseSeries)
homeWindow.setProperty('context.watchdogs.browseEpisodes', browseEpisodes)
...
if action is None:
    ...
    if cache._find_cache_version():
        run = 'true'
    if run == 'true':
        control.execute('RunPlugin(plugin://plugin.video.watchdogs/?action=cleanSettings)')
...
####################################################
    ...
    from resources.lib.menus import foreign
...
####################################################
    ...
    from resources.lib.menus import streamlive
...
####################################################
#--- Most Played-Watched-Collected Movies & Tv
####################################################
...
#--- Random Movies & Tv
####################################################
elif action == 'randmovie':
    from resources.lib.menus import navigator
    navigator.Navigator().randmovie()
elif action == 'randtv':
    from resources.lib.menus import navigator
    navigator.Navigator().randtv()
...
####################################################
    ...
    from resources.lib.menus import lists
    lists.indexer().root_music()
elif action == 'oneclick':
    from resources.lib.menus import lists
    lists.indexer().root_oneclick()
elif action == 'porn':
    from resources.lib.menus import lists
    lists.indexer().root_porn()
elif action == 'watchdogslive':
    from resources.lib.menus import lists
    lists.indexer().root()
...
####################################################
#elif action == 'tvtap':
    #xbmc.executebuiltin('RunAddon(script.xjctvtap)')
elif action == 'tvtap':
    from resources.lib.menus import lists
    lists.indexer().root_tvtap()
...
####################################################
#--- Movie & Tv Shows Trailers / Reviews
####################################################
...
####################################################
    ...
    from resources.lib.menus import navigator
    navigator.Navigator().userlists()

elif action == 'U53R1nav':
    from resources.lib.menus import navigator
    navigator.Navigator().wolfgirl()

elif action == 'U53R2nav':
    from resources.lib.menus import navigator
    navigator.Navigator().shadowhawks()

elif action == 'U53R3nav':
    from resources.lib.menus import navigator
    ...
    from resources.lib.menus import navigator
    navigator.Navigator().userName5()


####################################################
# WolfGirl
####################################################
elif action == 'wolfgirlNavigator':
    from resources.lib.menus import navigator
    navigator.Navigator().wolfgirl()

elif action == 'wolfgirlMovies':
    from resources.lib.menus import movies
    movies.Movies().get(url)
...
####################################################
    ...
    for i in items:
        ...
        url = 'plugin://plugin.video.watchdogs/?action=play&title=%s&year=%s&imdb=%s&tvdb=%s&season=%s&episode=%s&tvshowtitle=%s&premiered=%s&meta=%s&select="2"' % (
...
elif action == 'contextWatchdogsSettings':
    control.openSettings('0.0', 'context.watchdogs')
...
####################################################
    ...
    if params.get('opensettings') == 'true':
        control.openSettings(query, "plugin.video.watchdogs")
...
####################################################
    ...
    if rtype == 'movie':
        from resources.lib.menus import movies
        rlist = movies.Movies().get(url, idx=False) #create_directory=False
        r = argv[0]+"?action=play"

    elif rtype == 'episode':
        from resources.lib.menus import episodes
        rlist = episodes.Episodes().get(tvshowtitle, year, imdb, tmdb, tvdb, season, idx=False) #create_directory=False
        r = argv[0]+"?action=play"

    elif rtype == 'season':
        from resources.lib.menus import seasons
        rlist = seasons.Seasons().get(tvshowtitle, year, imdb, tmdb, tvdb, idx=False) #create_directory=False
        r = argv[0]+"?action=random&rtype=episode"

    elif rtype == 'show':
        from resources.lib.menus import tvshows
        rlist = tvshows.TVshows().get(url, idx=False) #create_directory=False
