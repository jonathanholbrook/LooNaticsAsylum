...
class trailer:
    def __init__(self):
        ...
        self.key_link = random.choice(['AIzaSyA9yT1w_INVCDteCgxGqXxi3FCkHrcb0q4',
                                       'AIzaSyBW3kkBVFyciWvZzoo0xI1mnQGGXso47o4',
                                       'AIzaSyDIrPcvlgCsyPuAxXXL896e9-vcoy8MQS8',
                                       'AIzaSyDHHwzdlP7TVnohDhjJ4cZLFkpeRfitwcs',
                                       'AIzaSyA1uYD3cTR8ch_jSuVJoVcTVgGSyenLVvs'])
        self.key_link = '&key={}'.format(self.key_link)
