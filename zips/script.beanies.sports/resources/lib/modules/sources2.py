...
#TC 2/01/19 started
        ...
        if control.addonInfo('id') == 'plugin.video.thebeanies':
            try:
                ...
                if quality == 'AUTO':
                    ...
                    control.window.clearProperty("plugin.video.thebeanies.container.items")
                    control.window.setProperty("plugin.video.thebeanies.container.items", json.dumps(items))

                    control.window.clearProperty("plugin.video.thebeanies.container.meta")
                    control.window.setProperty("plugin.video.thebeanies.container.meta", meta)
                    control.window.clearProperty(self.itemProperty)
                    control.window.setProperty(self.itemProperty, json.dumps(items))
    ...
    def sourcesFilter(self):
        ...
        sortthebeanies = control.setting('torrent.sort.the.beanies')
        if sortthebeanies == '':
            sortthebeanies = 'false'
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.thebeanies.container.items'

        self.metaProperty = 'plugin.video.thebeanies.container.meta'
