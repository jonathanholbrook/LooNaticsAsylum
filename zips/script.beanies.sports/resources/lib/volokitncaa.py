...
def get_games():
    ...
    html = scraper.get(r"http://www.volokit.com/all-games/schedule/ncaa.php",headers={'user-agent':agent}).content
...
#print(get_stream("http://www.volokit.com/volostream/nfl-games/chiefs-jaguars/"))
#print(get_games())
