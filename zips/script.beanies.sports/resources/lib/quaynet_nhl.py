...
u_link = 'http://quaynet.us/category/nhl-streams/'
...
def get_stream(link):
    ...
    if encrypt:
        ...
        stream.append({'title': '[COLOR orchid]*[/COLOR] [B][COLOR white]Play Stream[/COLOR][/B] [COLOR orchid]*[/COLOR]', 'stream': decrypt + nhl_auth})
    else:
        pass
