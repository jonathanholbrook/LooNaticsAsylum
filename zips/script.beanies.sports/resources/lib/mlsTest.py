...
def get_game():
    ...
    html = requests.get(r"https://mls-live.stream/",headers=headers).content
...
def get_stream(link):
    ...
    iframe = frame['src']
    if iframe:
        iframe = "https://mls-live.stream" + iframe
...
#print(get_game())
#get_stream("https://mls-live.stream/watch/fc-cincinnati-live.html")
