...
import xbmc
import xbmcgui
from resources.lib.modules import cache, metacache, client, control, regex, trailer, workers, youtube, views, trakt, common, notify
...
addon_id = 'plugin.video.thebeanies'
ADDON_FOLDER = xbmc.translatePath(
    os.path.join('special://home/addons/' + addon_id))
TERMS = xbmc.translatePath(os.path.join(
    ADDON_FOLDER, 'resources/disclaimer.txt'))
DATA_FOLDER = xbmc.translatePath(os.path.join(
    'special://home/userdata/addon_data/' + addon_id))
I_AGREE = xbmc.translatePath(os.path.join(DATA_FOLDER, 'agreed.txt'))
fanart = xbmc.translatePath(os.path.join(
    'special://home/addons/' + addon_id, 'fanart.gif'))
...
class indexer:
    ...
    def root_porn(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/turkey/xxx.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
    ...
    def root_base(self):
        try:
            regex.clear()
            url = 'https://pastebin.com/raw/K3YSAUsD'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_waste(self):
        try:
            regex.clear()
            url = 'http://dystopiabuilds.xyz/waste/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_titan(self):
        try:
            regex.clear()
            url = 'http://magnetic.website/Mad%20Titan/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_greyhat(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/snake/greyhat_main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_yellowhat(self):
        try:
            regex.clear()
            url = 'https://pastebin.com/raw/d5cb3Wxw'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_redhat(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/bear/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_yss(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/yss.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_weak(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/weak.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_sportsbay(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/sportsbay.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_sports24(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/sportstwnetyfour_tv.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_arconai(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/arconaitv.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_blackhat(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/penguin/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_food(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/food/food_main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_greenhat(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/ghost/green.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_absolution(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/absolution/absolution_main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_eyecandy(self):
        try:
            regex.clear()
            url = 'http://www.hazmatcorner.com/eyecandynew/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_retribution(self):
        try:
            regex.clear()
            url = 'http://www.hazmatcorner.com/retributionnew/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_iptv(self):
        try:
            regex.clear()
            url = 'https://pastebin.com/raw/ZzGTySZE'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_247movies(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/247movies.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_247tvshows(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/247shows.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_ncaa(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/ncaa/ncaa.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_ncaab(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/ncaa/ncaab.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_lfl(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/lfl/lfl.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_mlb(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/mlb/mlb.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_nfl(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/nfl/nfl.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_nhl(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/nhl/nhl.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_nba(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/nba/nba.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_ufc(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/ufc_mma/ufc.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_motogp(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/motor/motogp.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_boxing(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/boxing/boxing.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_fifa(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/fifa/fifa.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_wwe(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/wwe/wwe.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_sports_channels(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/channels/channels.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_sreplays(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/replays/replays.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_iptv_lodge(self):
        try:
            regex.clear()
            url = 'https://pastebin.com/raw/2D80tRy5'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_stratus(self):
        try:
            regex.clear()
            url = 'https://pastebin.com/raw/4cQ9mj8X'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_faith(self):
        try:
            regex.clear()
            url = 'https://pastebin.com/raw/ikshwe1W'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_cctv(self):
        try:
            regex.clear()
            url = 'https://pastebin.com/raw/pQJ9pFjH'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_misc_sports(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/misc/misc_sports.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_tennis(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/tennis/tennis.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_f1(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/motor/f1.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_pga(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/pga/pga.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_kiddo(self):
        try:
            regex.clear()
            url = 'http://cellardoortv.com/kiddo/master/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_purplehat(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/cat/CCcinema.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_git(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/main.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_nascar(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/nascar/nascar.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def root_xfl(self):#
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/xfl/xfl.xml'
            self.list = self.the_beanies_list(url)
    ...
    def root_tubi(self):#
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/tubitv.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_pluto(self):#
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/pluto.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_bumble(self):#
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/bumblebee.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_xumo(self):#
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/xumo.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_distro(self):#
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/egg/distro.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_cricket(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/beanies/clown/cricket/cricket.xml'
            self.list = self.the_beanies_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def getx(self, url, worker=False):
        try:
            ...
            url = regex.resolve(r)
            self.list = self.the_beanies_list('', result=url)
            self.addDirectory(self.list)
            return self.list
        except:
            pass
    ...
    def developer(self):
        try:
            ...
            result = f.read()
            f.close()
            self.list = self.the_beanies_list('', result=result)
            for i in self.list:
    ...
    def youtube(self, url, action):
        try:
            ...
            if 'PlaylistTuner' in action:
                ...
                self.list = cache.get(youtube.youtube(
            ...
            if 'Tuner' in action:
                ...
                for i in self.list:
                    i.update({'name': i['title'], 'poster': i['image'],
                              'nextaction': action, 'action': 'plugin', 'folder': False})
                self.addDirectory(self.list)
    ...
    def tvtuner(self, url):
        try:
            ...
            today = ((datetime.datetime.utcnow() -
                      datetime.timedelta(hours=5))).strftime('%Y-%m-%d')
            today = int(re.sub('[^0-9]', '', str(today)))

            url, imdb, tvdb, tvshowtitle, year, thumbnail, fanart = re.findall('<url>(.+?)</url>', url)[0], re.findall('<imdb>(.+?)</imdb>', url)[0], re.findall('<tvdb>(.+?)</tvdb>', url)[0], re.findall(
                '<tvshowtitle>(.+?)</tvshowtitle>', url)[0], re.findall('<year>(.+?)</year>', url)[0], re.findall('<thumbnail>(.+?)</thumbnail>', url)[0], re.findall('<fanart>(.+?)</fanart>', url)[0]

            tvm = client.request(
                'http://api.tvmaze.com/lookup/shows?thetvdb=%s' % tvdb)
            if tvm == None:
                tvm = client.request(
    ...
    def search(self, url):
        try:
            ...
            if (url == None or url == ''):
                ...
                self.list = [
                    {'name': 30702, 'url': url, 'action': 'addSearch'}]
                self.list += [{'name': 30703, 'action': 'delSearch'}]
    ...
    def addSearch(self, url):
        ...
        def search(): return [x for y, x in enumerate(
            (query + [input])) if x not in (query + [input])[:y]]
        ...
        if section == 0:
            ...
            links = [i for i in links if str(i).startswith(
                'http') and matcher.lower() in str(i).lower()]

        self.list = []
        threads = []
        for link in links:
            threads.append(workers.Thread(self.the_beanies_list, link))
    ...
    def the_beanies_list(self, url, result=None):
        ...
        try:
            ...
            items = re.compile(
                '((?:<item>.+?</item>|<dir>.+?</dir>|<plugin>.+?</plugin>|<info>.+?</info>|<name>[^<]+</name><link>[^<]+</link><thumbnail>[^<]+</thumbnail><mode>[^<]+</mode>|<name>[^<]+</name><link>[^<]+</link><thumbnail>[^<]+</thumbnail><date>[^<]+</date>))', re.MULTILINE | re.DOTALL).findall(result)
        except:
            return
        ...
        for item in items:
            try:
                ...
                item = re.sub(
                    '<sublink></sublink>|<sublink\s+name=(?:\'|\").*?(?:\'|\")></sublink>', '', item)
                ...
                try:
                    ...
                    url = '0'
                url = url.replace(
                    '>search<', '><preset>search</preset>%s<' % meta)
                url = '<preset>search</preset>%s' % meta if url == 'search' else url
                url = url.replace(
                    '>searchsd<', '><preset>searchsd</preset>%s<' % meta)
                url = '<preset>searchsd</preset>%s' % meta if url == 'searchsd' else url
                url = re.sub(
                    '<sublink></sublink>|<sublink\s+name=(?:\'|\").*?(?:\'|\")></sublink>', '', url)
                ...
                self.list.append({'name': name, 'vip': vip, 'url': url, 'action': action, 'folder': folder, 'poster': image2, 'banner': '0', 'fanart': fanart2, 'content': content, 'imdb': imdb,
                                  'tvdb': tvdb, 'tmdb': '0', 'title': title, 'originaltitle': title, 'tvshowtitle': tvshowtitle, 'year': year, 'premiered': premiered, 'season': season, 'episode': episode})
            except:
                pass
    ...
    def tv_info(self, i):
        try:
            ...
            item = client.request(url, output='extended',
                                  error=True, timeout='10')
            ...
            self.meta.append({'imdb': imdb, 'tmdb': '0', 'tvdb': tvdb, 'lang': self.lang, 'item': {'tvshowtitle': tvshowtitle, 'year': year,
                                                                                                   'code': imdb, 'imdb': imdb, 'tvdb': tvdb, 'studio': studio, 'genre': genre, 'duration': duration, 'rating': rating, 'plot': plot}})
        except:
            pass
    ...
    def addDirectory(self, items, queue=False):
        ...
        for i in items:
            try:
                ...
                try:
                    devurl = dict(urlparse.parse_qsl(
                ...
                if content in ['movies', 'tvshows']:
                    ...
                    cm.append((control.lang(30707).encode(
                        'utf-8'), 'RunPlugin(%s?action=trailer&name=%s)' % (sysaddon, urllib.quote_plus(name))))

                if content in ['movies', 'tvshows', 'seasons', 'episodes']:
                    cm.append((control.lang(30708).encode(
                        'utf-8'), 'XBMC.Action(Info)'))
                ...
                if content == 'movies':
                    ...
                    try:
                        cm.append((control.lang(30722).encode('utf-8'), 'RunPlugin(%s?action=addDownload&name=%s&url=%s&image=%s)' %
                                   (sysaddon, urllib.quote_plus(dfile), urllib.quote_plus(i['url']), urllib.quote_plus(poster))))
                    except:
                        pass
                    ...
                    try:
                        cm.append((control.lang(30722).encode('utf-8'), 'RunPlugin(%s?action=addDownload&name=%s&url=%s&image=%s)' %
                                   (sysaddon, urllib.quote_plus(name), urllib.quote_plus(i['url']), urllib.quote_plus(poster))))
                    except:
                        pass

                if mode == 'movies':
                    cm.append((control.lang(30711).encode(
                        'utf-8'), 'RunPlugin(%s?action=addView&content=movies)' % sysaddon))
                elif mode == 'tvshows':
                    cm.append((control.lang(30712).encode(
                        'utf-8'), 'RunPlugin(%s?action=addView&content=tvshows)' % sysaddon))
                elif mode == 'seasons':
                    cm.append((control.lang(30713).encode(
                        'utf-8'), 'RunPlugin(%s?action=addView&content=seasons)' % sysaddon))
                elif mode == 'episodes':
                    cm.append((control.lang(30714).encode(
                        'utf-8'), 'RunPlugin(%s?action=addView&content=episodes)' % sysaddon))

                if devmode == True:
                    try:
                        cm.append(('Open in browser', 'RunPlugin(%s?action=browser&url=%s)' % (
                ...
                if queue == False:
                    ...
                    control.addItem(handle=int(
                        sys.argv[1]), url=url, listitem=item, isFolder=folder)
                else:
                    item.setInfo(type='Video', infoLabels=meta)
        ...
        try:
            ...
            item.setArt({'addonPoster': addonPoster, 'thumb': addonPoster, 'poster': addonPoster, 'tvshow.poster': addonPoster,
                         'season.poster': addonPoster, 'banner': addonPoster, 'tvshow.banner': addonPoster, 'season.banner': addonPoster})
            item.setProperty('addonFanart_Image', addonFanart)
            control.addItem(handle=int(
                sys.argv[1]), url=url, listitem=item, isFolder=True)
        except:
            pass
...
class resolver:
    def browser(self, url):
        try:
            ...
            if url == False:
                return
            control.execute(
                'RunPlugin(plugin://plugin.program.chrome.launcher/?url=%s&mode=showSite&stopPlayback=no)' % urllib.quote_plus(url))
        except:
            pass
    ...
    def get(self, url):
        try:
            ...
            items = [('Link %s' % (int(items.index(i))+1) if i[0]
                      == '' else i[0], i[1]) for i in items]
    ...
    def f4m(self, url, name):
        try:
            if not any(i in url for i in ['.f4m', '.ts', '.m3u8']):
                raise Exception()
            ext = url.split('?')[0].split('&')[0].split(
                '|')[0].rsplit('.')[-1].replace('/', '').lower()
            if not ext:
                ext = url
            if not ext in ['f4m', 'ts', 'm3u8']:
                raise Exception()
    ...
    def process(self, url, direct=True):
        ...
        try:
            ...
            u = sources2.sources().getSources(title, year, imdb, tvdb, season,
