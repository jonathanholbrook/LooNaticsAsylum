...
_addon = xbmcaddon.Addon(id='plugin.video.thebeanies')
...
def skinTheme():
    ...
    if theme in ['-', '']:
        return
    elif control.condVisibility('System.HasAddon(script.thebeanies.artwork)'):
        return theme
...
def skinModule():
    ...
    if theme in ['-', '']:
        ...
        aModule = xbmcaddon.Addon('script.thebeanies.artwork').getSetting('artwork_module')
