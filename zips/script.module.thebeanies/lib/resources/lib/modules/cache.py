...
def _find_cache_version():
    ...
    try: 
        ...
        import xbmc
        print 'TheBeanies Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.thebeanies')
        os.makedirs(ad_folder)
    try:
        with open(versionFile, 'rb') as fh: oldVersion = fh.read()
    except: oldVersion = '0'
    try:
        curVersion = control.addon('script.module.thebeanies').getAddonInfo('version')
