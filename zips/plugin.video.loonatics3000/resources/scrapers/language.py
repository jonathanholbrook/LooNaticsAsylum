...
_strings['the noobsandnerds add-on portal is showing a newer version of [color=gold]%s[/color] is available. would you like to update to version: [color=goldenrod]%s[/color]'] = 30976
