...
class RealDebrid:
    ...
    def token_request(self):
        ...
        xbmcgui.Dialog().ok('Loonatics 3000', 'Real Debrid ' + "Authentication is completed")
    ...
    def singleMagnetToLink(self, magnet):
        ...
        try:
            ...
            while status!='downloaded':
                ...
                if res['status']=='waiting_files_selection':
                    ...
                    if len(res['files'])>0:
                        ...
                        if f_id=='':
                          xbmc.executebuiltin((u'Notification(%s,%s)' % ('Loonatics 3000', 'Rd Failed in torrent')).encode('utf-8'))
                        if 'id' in torrent:
            ...
            xbmc.executebuiltin((u'Notification(%s,%s)' % ('Loonatics 3000', 'Line:'+str(lineno)+' E:'+str(e))).encode('utf-8'))
