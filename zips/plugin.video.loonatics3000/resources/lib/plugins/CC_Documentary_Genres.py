...
"""
    ...
    Returns the CC Documentary Genres list-

    <dir>
    <title>CC Horror Documentaries</title>
    <CC2_dg>all</CC2_dg>
    </dir>
...
----------------------------------------------------------
"""
table_id = "apppU1oz3VWB0kUT3"
table_name = "Documentaries By Genre"
...
class CC2_dg(Plugin):
    ...
    def process_item(self, item_xml):
        if "<CC2_dg>" in item_xml:
            item = JenItem(item_xml)
            if "all" in item.get("CC2_dg", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_CC2_dg_shows",
                    'url': item.get("CC2_dg", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
                ...
                return result_item              
            elif "show|" in item.get("CC2_dg", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_CC2_selected_show",
                    'url': item.get("CC2_dg", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
...
@route(mode='open_CC2_dg_shows')
def open_CC2_dg_shows():
    pins = ""
    xml = ""
...
@route(mode='open_CC2_selected_show',args=["url"])
