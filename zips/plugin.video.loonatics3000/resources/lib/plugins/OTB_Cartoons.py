...
"""
    ...
    Returns the OTB Cartoons list-

    <dir>
    <title>OTB Cartoons</title>
    <otb2_car>all</otb2_car>
    </dir>
...
----------------------------------------------------------
"""
table_id = "app2OWKcOzZQr1Nwk"
table_name = "OTB Cartoons"
...
class OTB2_car(Plugin):
    name = "otb2_car"

    def process_item(self, item_xml):
        if "<otb2_car>" in item_xml:
            item = JenItem(item_xml)
            if "all" in item.get("otb2_car", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_otb2_car_shows",
                    'url': item.get("otb2_car", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
                    'episode': "0",
                ...
                return result_item              
            elif "show|" in item.get("otb2_car", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_otb2car_selected_show",
                    'url': item.get("otb2_car", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
                ...
                result_item['fanart_small'] = result_item["fanart"]
                return result_item 
            elif "season|" in item.get("otb2_car", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_otb2car_season",
                    'url': item.get("otb2_car", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
...
@route(mode='open_otb2_car_shows')
def open_otb2_car_shows():
    xml = ""
...
@route(mode='open_otb2car_selected_show',args=["url"])
...
@route(mode='open_otb2car_season',args=["url"])
def open_selected_show(url):
    xml = ""
    title = url.split("|")[-3]
    key = url.split("|")[-2]
