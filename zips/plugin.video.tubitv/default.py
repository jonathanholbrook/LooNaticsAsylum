...
def start():
	url = "https://tubitv.com/oz/containers?isKidsModeEnabled=false&groupStart=7&groupSize=66"
	payload = {}
	headers = {
...
def tubitv_cats(url,page):
	url2 = "https://tubitv.com/oz/containers/%s/content?parentId&cursor=10&limit=250&isKidsModeEnabled=false&expand=0"%(url)
	payload = {}
	headers = {
	  'authority': 'tubitv.com',
	  'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36',
